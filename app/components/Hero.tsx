...
export default function Hero() {
  ...
  return (
      <section id="presentation" className="pt-24 mx-auto max-w-screen-xl pb-12 px-4 items-center lg:flex md:px-8">
        <div className="space-y-4 flex-1 sm:text-center lg:text-left">
          ...
          <p className="text-black max-w-xl leading-relaxed sm:mx-auto lg:ml-0">
            ...
            l'ISEFAC et je suis à la recherche d'une opportunité d'alternance
